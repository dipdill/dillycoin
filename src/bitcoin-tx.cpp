...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " dillycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  dillycoin-tx [options] <hex-tx> [commands]  Update hex-encoded dillycoin transaction\n" +
            "or:     dillycoin-tx [options] -create [commands]   Create hex-encoded dillycoin transaction\n" +
            "\n";
