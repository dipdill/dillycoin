...
"""Verify that starting dillycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dillycoin with -h for help text")
        ...
        self.log.info("Start dillycoin with -version for version information")
        ...
        self.log.info("Start dillycoind with -fakearg to make sure it does not start")
